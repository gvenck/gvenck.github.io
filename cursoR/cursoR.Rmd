...
A função também é considerada um objeto no R, portanto você a atribui à uma variável, nesse caso à `myfuncao`. Então estabelece os argumentos da função, nesse caso `x` e `y`. Entre as chaves fica todo o corpo da função. Se você quer que a função retorne algum valor, é necessário utilizar o `return`.
