...
Claramente a análise de dados é algo muito específico de cada conjunto de dados e interesses. Vamos aqui mostrar alguns recursos básicos como análise de variância, correlação e teste de médias.

Algumas avaliações descritivas podem ser feitas pelo uso do `tapply,` como já mostrado anteriormente, e de gráficos, mostraremos a seguir .
